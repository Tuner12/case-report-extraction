...
```bash
python "$CLAUDE_SKILL_DIR/scripts/audit_figure_assets.py" CR10 --report CR10/figure_asset_report.json --contact-sheet CR10/figure_contact_sheet.png
```

Audit extracted table workbooks and create a row/column preview:

```bash
python "$CLAUDE_SKILL_DIR/scripts/audit_table_assets.py" CR10 --report CR10/table_asset_report.json --preview CR10/table_asset_preview.md
```
